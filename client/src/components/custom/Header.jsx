            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="hidden md:flex items-center gap-3">
                        {/* Simple Chat Button */}
                        <Link to="/chat">
                            <Button size="sm" variant="outline" className="h-9 px-5 font-semibold text-black bg-transparent border border-white hover:bg-white hover:text-black rounded-full transition-all duration-300">
                                Chat
                            </Button>
                        </Link>
                        ...
                        {user ? (
                            ...
                            <div className="flex items-center gap-3 ml-2 pl-2">
                                <Link to="/login">
                                    <Button variant="outline" size="sm" className="text-sm font-bold !text-black border-white bg-transparent hover:bg-white/10 rounded-full h-10 px-6 transition-all border shadow-none">
                                        Login
                                    </Button>
                                </Link>
                                <Link to="/register">
