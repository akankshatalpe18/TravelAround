            ...
            <div className="w-full max-w-[1280px] mx-auto border border-white/20 rounded-[32px] overflow-hidden flex flex-col lg:flex-row bg-[#080808]">
                ...
                <div className="w-full lg:w-[45%] flex flex-col justify-center p-12 lg:p-20 z-10 shrink-0">
                    ...
                    <div className="flex items-center gap-6">
                        <button className="px-6 py-2.5 rounded-full border border-white text-black font-inter font-bold text-[13px] hover:bg-white hover:text-black transition-all">
                            Explore
                        </button>
                        <button className="text-black font-inter font-bold text-[13px] flex items-center gap-1.5 hover:text-gray-300 transition-colors">
                            Stories
                            <svg width="16" height="16" viewBox="0 0 30 30" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="m9 18 6-6-6-6" /></svg>
                        </button>
                    </div>
                </div>
