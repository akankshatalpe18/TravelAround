            ...
            <div className="relative w-full h-full max-w-7xl mx-auto flex flex-col justify-between z-20">
                ...
                <div className="w-full max-w-xl self-end mb-8 sm:mb-12 bg-black/20 p-6 sm:p-8 rounded-lg backdrop-blur-md border border-white/10">
                    <p className="text-white text-base sm:text-lg font-inter font-medium mb-6 leading-relaxed">
                        Discover new destinations, build personalized itineraries, find the perfect hotels, and make every journey unforgettable.
                    </p>
                    ...
                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
                        ...
                        <Link to="#learn-more" className="w-full sm:w-auto">
                            <Button
                                variant="outline"
                                className="h-14 sm:h-12 w-full px-8 text-black border border-white/30 bg-white/5 backdrop-blur-sm hover:border-white hover:bg-white/10 font-inter font-bold text-[14px] transition-all rounded-sm shadow-none active:scale-95"
                            >
                                Learn more
                            </Button>
                        </Link>
