                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div className="lg:col-span-4 flex flex-col gap-8">
                        ...
                        <div className="bg-[#0a0a0a] border border-white/10 rounded-[32px] p-8 sm:p-10 flex flex-col justify-between h-full transition-all duration-500 hover:border-white/20 group hover:bg-[#0f0f0f]">
                            <div>
                                ...
                                <h3 className="text-3xl font-bold font-urbanist leading-tight mb-4 tracking-tight">AI-Crafted Itineraries</h3>
                                <p className="text-gray-400 font-inter text-[15px] leading-relaxed mb-12">From hidden gems to must-see attractions, every itinerary is tailored just for you.</p>
                            </div>
                    ...
                    <div className="lg:col-span-8 bg-[#0a0a0a] border border-white/10 rounded-[32px] overflow-hidden flex flex-col transition-all duration-500 hover:border-white/20 group hover:bg-[#0f0f0f]">
                        <div className="p-8 sm:p-12">
                            ...
                            <h3 className="text-[32px] sm:text-[45px] lg:text-[54px] font-urbanist font-black leading-[1.1] mb-6 tracking-tight">Make every trip <br className="hidden sm:block" /> truly yours</h3>
                            <p className="text-lg text-gray-400 font-inter mb-10 max-w-xl">Add destinations, swap activities, and fine-tune every detail with AI recommendations.</p>
